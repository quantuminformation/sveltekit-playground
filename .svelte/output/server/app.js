...
function load({page, fetch: fetch2, session, context}) {
  debugger;
  return {error: new Error(`Could`)};
}
const Load = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let {test: test2} = $$props;
  if ($$props.test === void 0 && $$bindings.test && test2 !== void 0)
    $$bindings.test(test2);
  return `${escape(test2)}`;
});
var load$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  default: Load,
  load
